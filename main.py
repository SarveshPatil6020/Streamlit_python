...
class MultiApp:
    ...
    def run():
        ...
        with st.sidebar: 
            ...
            st.markdown('<img class="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTcB1P4ro9TNMwSUaSVjYz8tBzhdu_NJeO_yg&usqp=CAU" alt="Custom Logo" style="height: 80px; position: absolute; align-item:center; top: -70px; left: 10px;z-index: 1;">', unsafe_allow_html=True)       
            app = option_menu(
                menu_title='MENU',
