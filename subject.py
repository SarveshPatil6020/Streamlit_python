...
#*************************************************IT*******************************************************************         
           if choice == "IT":
               with col2:
                ...
                if choice1=="SE":
                    with col1:
                        choice11 = st.selectbox('select Division',['None','SE9','SE10','SE11']) 
                        if choice11 =="SE9":
                            with col2: 
                ...
                if choice1=="TE":
                    with col1:
                        choice12 = st.selectbox('select Division',['None','TE9','TE10','TE11']) 
                        if choice12 =="TE9":
                            with col2: 
                ...
                if choice1=="BE":
                    with col1:
                        choice13 = st.selectbox('select Division',['None','BE9','BE10','BE11']) 
                        if choice13 =="BE9":
                            with col2: 
...
#*************************************************COMP*******************************************************************         
           ...
           if  choice == "COMP":
               with col2:
                   ...
                   if choice2=="SE":
                    with col1:
                        choice21 = st.selectbox('select Division',['Both SEM','SE9','SE10','SE11']) 
                        if choice21 =="SE9":
                            with col2: 
                   ...
                   if choice2=="TE":
                    with col1:
                        choice22 = st.selectbox('select Division',['None','TE9','TE10','TE11']) 
                        if choice22 =="TE9":
                            with col2: 
                   ...
                   if choice2=="BE":
                    with col1:
                        choice23 = st.selectbox('select Division',['None','BE9','BE10','BE11']) 
                        if choice23 =="BE9":
                            with col2: 
...
#*************************************************E&TC*******************************************************************         
           ...
           if  choice == "E&TC":
               with col2:
                   ...
                   if choice3=="SE":
                    with col1:
                        choice31 = st.selectbox('select Division',['None','SE9','SE10','SE11']) 
                        if choice31 =="SE9":
                            with col2: 
                   ...
                   if choice3=="TE":
                    with col1:
                        choice32 = st.selectbox('select Division',['None','TE9','TE10','TE11']) 
                        if choice32 =="TE9":
                            with col2: 
                   ...
                   if choice3=="BE":
                    with col1:
                        choice33 = st.selectbox('select Division',['None','BE9','BE10','BE11']) 
                        if choice33 =="BE9":
                            with col2: 
