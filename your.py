...
#**************************************************SE********************************************
        ...
        # Retrieve username from session state
           ...
           choice = st.selectbox('select class',['None','SE9','SE10','SE11'])
           if choice == "SE9":
...
#****************************************************TE**********************************
       ...
       # div wise
             choice = st.selectbox('select class',['None','TE9','TE10','TE11'])
             if choice == "TE9":
...
#****************************************************BE**********************************
       ...
       # div wise
             choice = st.selectbox('select class',['None','BE9','BE10','BE11'])
             if choice == "BE9":
                  path232= TE9_file_path
                  attainment(path232)
             if choice == "BE10":
